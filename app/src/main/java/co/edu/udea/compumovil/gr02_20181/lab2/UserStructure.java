...
public class UserStructure {
    ...
    public ContentValues toContentValues() {
        ...
        values.put(RestaurantDB.ColumnUser.USER_NAME, user_name);
        values.put(RestaurantDB.ColumnUser.USER_EMAIL,user_email);
        values.put(RestaurantDB.ColumnUser.USER_PASSWORD, user_password);
        values.put(RestaurantDB.ColumnUser.USER_PICTURE, user_picture);
        values.put(RestaurantDB.ColumnUser.USER_STATE, user_state);
        return values;
    }
